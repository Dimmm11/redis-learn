...
import static com.example.redis_demo_my.utils.Constants.ACCESS_TOKEN;
...
import static com.example.redis_demo_my.utils.RequestUtils.extractFieldValue;
...
public class JWTTokenValidatorFilter extends OncePerRequestFilter implements JwtTokenFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull FilterChain filterChain)
        ...
        String jwt = extractFieldValue(request, ACCESS_TOKEN, objectMapper);
        if (jwt != null) {
            try {
